...
function makeStrings(arr) {
  var array = arr.map(z => {
    ...
    if (z.age >= 18)
      z = z.name + " can go to The Matrix"
    else
      z = z.name + "  is under age!!"
...
function extractFullName(arr) {
  var array = arr.map(z => z.first + " " + z.last
  )
  return array
}